...
function SocialNetworks({ socialNetworks, setSocialNetworks }) {
  const handleSocialNetworkChange = (index, newState) => {
    const updatedSocialNetworks = socialNetworks.map((socialNetwork, i) => {
      if (i === index) {
