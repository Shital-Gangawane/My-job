...
function HowItWorks() {
  ...
  return (
    <div className="w-full h-auto mx-auto px-10 py-5 pb-5 md:px-10 bg-white flex flex-col items-center">
      <motion.div
      ...
      >
        <div className="text-start w-full px-4 mt-12 mb-8 md:px-32 sm:px-4 sm:mt-16 sm:mb-10">
          <h1 className="font-medium text-4xl text-center text-gray-800  sm:text-3xl lg:text-4xl mb-4 sm:mb-5">
            How It Works?
          </h1>
          <h2 className=" font-medium text-xl text-center mb-4 text-gray-500 sm:text-xl sm:mb-5">
            Find Candidates in 3 easy steps:
          </h2>
          <p className="md:px-48 text-sm text-center sm:px-4 text-gray-500 sm:text-sm">
            Getting applied by an expert talent involves attracting highly
            skilled professionals to apply for your job openings, ensuring your
            company secures top-tier candidates for its positions.
          </p>
        </div>
              ...
              >
                <Card className="">
                  <Card.Body className="text-center sm:py-10">
                    <div
                      className={`${data.bgColor} text-${data.color}-600 text-center py-5 w-24 h-24  mx-auto rounded-full transition duration-300 ease-in-out`}
                    >
                      {data.icon}
                    </div>
                    <div className="w-full items-end">
                      ...
                      <Card.Text
                        className={`justify-center text-gray-600  text-md `}
                      >
                        {data.p}
                      </Card.Text>
                    </div>
