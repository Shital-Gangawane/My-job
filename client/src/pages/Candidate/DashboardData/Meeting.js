...
function Meeting() {
  ...
  return (
    <div className="relative w-full h-auto lg:mt-14 px-4 lg:px-14 overflow-y-auto py-7 pb-14">
      <div className="flex flex-col md:flex-row items-start md:items-center   md:justify-between mb-10">
        ...
        <div className="">
          <button
            ...
            className="bg-[#6ad61d] text-white px-2 py-2 md:px-7 md:py-3 rounded-lg mr-2"
          >
          ...
          <button
            ...
            className="bg-blue-500 text-white  px-2 py-2 md:px-7 md:py-3 rounded-lg mr-2"
          >
          ...
          <button
            ...
            className="bg-red-500 text-white  px-2 py-2 md:px-7 md:py-3 rounded-lg"
          >
